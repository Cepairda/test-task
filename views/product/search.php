...
<div class="shoes-grid">
    ...
    <?php if (!empty($products) and !empty($name)): ?>
        <div class="products">
            <h5 class="latest-product">Поиск товара по имени - <?= $name ?></h5>
        </div>
    ...
    <?php else: ?>
        <div class="products">
            <h5 class="latest-product"><?= 'По вашему запросу ничего не найдено.' ?></h5>
        </div>
    <?php endif; ?>
    <div class="clearfix"> </div>
</div>
